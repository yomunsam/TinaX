...
{
    unsafe class TinaX_I18N_II18N_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(TinaX.I18N.II18N);
        ...
        static StackObject* GetText_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.String @defaultText = (System.String)typeof(System.String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            TinaX.I18N.II18N instance_of_this_method = (TinaX.I18N.II18N)typeof(TinaX.I18N.II18N).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            var result_of_this_method = instance_of_this_method.GetText(@key, @groupName, @defaultText);
